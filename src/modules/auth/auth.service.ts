import { Get, HttpCode, HttpException, HttpStatus, Injectable, Post, UseGuards } from "@nestjs/common";
...
export class AuthService {
  ...
  async checkEmailForgotPassword(email: string) {
    ...
    if (!user) {
      throw new HttpException('No users have been registered with this email', HttpStatus.NOT_FOUND);
    }
